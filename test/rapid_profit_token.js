...
contract('RapidProfit', (accounts) => {
    ...
    it('verification of Token deposition', async ()  => {
        ...
        await contractToken.depositToken(accounts[1], 0, currentTime, OneToken, {from:accounts[0]});
   ...
   it('verification of Token validWithdraw', async ()  => {
        var currentTime = 1522800000; // Wed, 04 Apr 2018 00:00:00 GMT
        balanceAccountOneBefore = await contractRP.balanceOfToken(accounts[1]);
        await contractToken.depositToken(accounts[1], 1, currentTime, TwoToken, {from:accounts[0]});
        balanceAccountOneAfter = await contractRP.balanceOfToken(accounts[1]);
        ...
        var profit = await contractRP.calculator.call(0, OneToken, Number((newTime - currentTime)/3600));
    ...
    it('verification of Token calculate of profit', async ()  => {
        ...
        await contractToken.depositToken(accounts[4], 0, currentTime, OneToken, {from:accounts[0]});
        await contractToken.depositToken(accounts[4], 1, currentTime, OneToken, {from:accounts[0]});
        await contractToken.depositToken(accounts[4], 2, currentTime, OneToken, {from:accounts[0]});
        ...
        var profitStake0 = await contractRP.calculator.call(0, OneToken, Number((newTime - currentTime)/3600));
        var profitStake1 = await contractRP.calculator.call(1, OneToken, Number((newTime - currentTime)/3600));
        var profitStake2 = await contractRP.calculator.call(2, OneToken, Number((newTime - currentTime)/3600));
        ...
        profitStake0 = await contractRP.calculator.call(0, OneToken, Number((newTime - currentTime)/3600));
        profitStake1 = await contractRP.calculator.call(1, OneToken, Number((newTime - currentTime)/3600));
        profitStake2 = await contractRP.calculator.call(2, OneToken, Number((newTime - currentTime)/3600));
        profitAll = Number(profitStake0) + Number(profitStake1) + Number(profitStake2);
        ...
        it('verification of Token cancel', async ()  => {
                var currentTime = 1522800002; // Wed, 04 Apr 2018 00:00:02 GMT
                balanceAccountForBefore = await contractRP.balanceOfToken(accounts[4]);
                //indexStake = await contractToken.depositToken.call(accounts[4], 2, currentTime, OneToken, {from:accounts[0]});
